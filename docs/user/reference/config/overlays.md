...
| Bugs | `bugs` | List of bug-tracker URLs related to this overlay. |
...
| `azl-compatibility` | Making a component work in the AZL build/runtime environment: toolchain and mock adjustments, workarounds for packages not yet imported into AZL, and similar compatibility fixes that are not themselves backports. |
...
bugs = ["https://bugzilla.redhat.com/show_bug.cgi?id=12345"]
