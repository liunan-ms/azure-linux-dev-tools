...
// pattern, matches are applied in filename (lexicographic) order. Duplicate
// matches across patterns are de-duplicated, preserving first occurrence. Each
// pattern is required to match at least one file.
